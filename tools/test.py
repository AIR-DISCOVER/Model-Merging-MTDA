...
def parse_args():
    ...
    parser.add_argument('--norm_select', type=int, default=0, choices=[0, 1])
...
def main():
    ...
    if args.eval_model:
        cfg.uda.eval_model = args.eval_model
    ...
    # breakpoint()
    '''
    # custom checkpoint loading causes state_dict mismatch for UDA models
    ...
    if not distributed:
        ...
        outputs = single_gpu_test(model, data_loader, args.show, args.show_dir,
                                  efficient_test, args.opacity, decoder_norm_select=args.norm_select)
    else:
        ...
        outputs = multi_gpu_test(model, data_loader, args.tmpdir,
                                 args.gpu_collect, efficient_test, decoder_norm_select=args.norm_select)
