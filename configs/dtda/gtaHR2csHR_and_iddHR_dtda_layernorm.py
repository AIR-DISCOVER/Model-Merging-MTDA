...
_base_ = [
    ...
    '../_base_/models/daformer_aspp_mitb5_layernorm.py',
...
name = 'gtaHR2csHR_and_iddHR_dtda_layernorm'
exp = 'basic'
name_dataset = 'gtaHR2cityscapesHR_and_ddHR_1024x1024'
name_architecture = 'hrda1-512-0.1_daformer_sepaspp_sl_mitb5_layernorm'
name_encoder = 'mitb5'
