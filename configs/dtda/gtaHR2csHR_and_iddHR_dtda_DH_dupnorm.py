...
# Default DTDA Configuration for GTA->Cityscapes&IDD
_base_ = [
    '../_base_/default_runtime.py',
    # DAFormer Network Architecture
    '../_base_/models/daformer_sepaspp_mitb5_DH_dupnorm.py',
    # GTA->Cityscapes High-Resolution Data Loading
    '../_base_/datasets/dtda_gtaHR_to_cityscapesHR_and_iddHR_1024x1024.py',
    # DAFormer Self-Training
    '../_base_/uda/dtda_a998_fdthings.py',
    # AdamW Optimizer
...
name = 'gtaHR2csHR_and_iddHR_dtda_DH_dupnorm'
exp = 'basic'
name_dataset = 'gtaHR2cityscapesHR_and_ddHR_1024x1024'
name_architecture = 'dtda1-512-0.1_daformer_sepaspp_sl_mitb5_DH_dupnorm'
name_encoder = 'mitb5'
name_decoder = 'dtda1-512-0.1_daformer_sepaspp_sl'
name_uda = 'dtda_a998_fdthings_rcs0.01-2.0_cpl2'
