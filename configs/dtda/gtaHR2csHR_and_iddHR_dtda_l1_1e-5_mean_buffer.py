...
_base_ = [
    ...
    '../_base_/uda/dtda_a998_fdthings_l1_1e-5_mean_buffer.py',
    # AdamW Optimizer
...
name = 'gtaHR2csHR_and_iddHR_dtda_l1_0.00001_mean_buffer'
exp = 'basic'
name_dataset = 'gtaHR2cityscapesHR_and_ddHR_1024x1024'
name_architecture = 'dtda1-512-0.1_daformer_sepaspp_sl_mitb5'
name_encoder = 'mitb5'
