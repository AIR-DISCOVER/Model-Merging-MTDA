...
_base_ = [
    ...
    '../_base_/models/daformer_sepaspp_r101_nPretrained.py',
    # GTA->Cityscapes High-Resolution Data Loading
    '../_base_/datasets/uda_gtaHR_to_cityscapes_iddHR_1024x1024.py',
...
name = 'gtaHR2cs_idd_combined_hrda_r101_seed' + str(seed)
exp = 'basic'
name_dataset = 'gtaHR2cityscapes&iddHR_1024x1024'
