...
_base_ = [
    ...
    # High-Resolution Data Loading
    # '../_base_/datasets/uda_gtaHR_to_darkzurichHR_1024x1024.py',
    '../_base_/datasets/uda_gtaHR_to_darkzurichHR_512x512.py',
...
name = 'gta2darkzurich_hrda_r101_seed' + str(seed)
exp = 'basic'
name_dataset = 'gtaHR2darkzurichHR_512x512'
