...
_base_ = [
    ...
    # '../_base_/datasets/uda_gtaHR_to_acdcHR_1024x1024.py',
    '../_base_/datasets/uda_gtaHR_to_acdcHR_512x512.py', 
...
name = 'gta2acdc_hrda_r101_seed' + str(seed)
exp = 'basic'
name_dataset = 'gtaHR2acdcHR_512x512'
