...
_base_ = [
    ...
    '../_base_/datasets/uda_gtasub1HR_to_cityscapesHR_1024x1024.py',
...
name = 'gta_sub1_HR2csHR_hrda_r101_seed' + str(seed)
exp = 'basic'
name_dataset = 'gta_sub1_HR2cityscapesHR_1024x1024'
