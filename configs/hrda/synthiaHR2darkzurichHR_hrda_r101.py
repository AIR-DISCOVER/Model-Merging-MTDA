...
_base_ = [
    ...
    # '../_base_/datasets/uda_synthiaHR_to_darkzurichHR_1024x1024.py',
    '../_base_/datasets/uda_synthiaHR_to_darkzurichHR_512x512.py',
...
name = 'synthia2darkzurich_hrda_r101_seed' + str(seed)
exp = 'basic'
name_dataset = 'synthiaHR2darkzurichHR_512x512'
