...
_base_ = [
    ...
    '../_base_/datasets/uda_synthiaHR_to_cityscapes_iddHR_1024x1024.py',
...
# name = 'gtaHR2cs&iddHR_hrda_s1'
name = 'synthiaHR2cs_idd_combined_hrda_r101_seed' + str(seed)
exp = 'basic'
name_dataset = 'synthiaHR2cityscapes&iddHR_1024x1024'
